(function (global, factory) {
	...
	(factory((global['angular-circular-slider'] = {}),global._angular_core,global._angular_common));
...
var CircularSliderComponent = (function () {
    function CircularSliderComponent() {
        ...
        this.onProgressChanged = new _angular_core.EventEmitter();
    }
...
CircularSliderComponent.propDecorators = {
    'handleContainer': [{ type: _angular_core.ViewChild, args: ['handleContainer',] },],
    'grooveContainer': [{ type: _angular_core.ViewChild, args: ['grooveContainer',] },],
    'startingAngleValue': [{ type: _angular_core.Input, args: ['startingAngle',] },],
    'endingAngleValue': [{ type: _angular_core.Input, args: ['endingAngle',] },],
    'grooveColorValue': [{ type: _angular_core.Input, args: ['grooveColor',] },],
    'progressColorValue': [{ type: _angular_core.Input, args: ['progressColor',] },],
    'grooveWidthValue': [{ type: _angular_core.Input, args: ['grooveWidth',] },],
    'progressWidthValue': [{ type: _angular_core.Input, args: ['progressWidth',] },],
    'bgColorValue': [{ type: _angular_core.Input, args: ['backgroundColor',] },],
    'handleWidthValue': [{ type: _angular_core.Input, args: ['handleWidth',] },],
    'diameterValue': [{ type: _angular_core.Input, args: ['diameter',] },],
    'total': [{ type: _angular_core.Input, args: ['total',] },],
    'progressValue': [{ type: _angular_core.Input, args: ['progress',] },],
    'onProgressChanged': [{ type: _angular_core.Output },],
};
...
exports.CircularSliderModule = CircularSliderModule;
exports.CircularSliderComponent = CircularSliderComponent;
